			...
			<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary">
				<ul class="nav nav-pills flex-column mb-auto">
					...
					<li class="nav-item"><a href="<%=root%>/user/update.jsp"
						class="nav-link active" aria-current="page"> 회원정보 수정 </a></li>
					<%
					}
					%>
				...
				<form action="update_pro.jsp" name="updateForm" method="post">
					...
					<div class="input-group mb-3 row">
						...
						<div class="col-md-10 d-flex align-items-center">
							<input type="hidden" name="temp-gender"
								value="<%=loginUser.getGender()%>" id="temp-gender" />
							<div class="radio-box d-flex">
								<div class="radio-item mx-5">
									<input type="radio" class="form-check-input" name="gender"
										value="여" id="gender-female"> <label
							...
							<div class="row">
								<div class="col">
									<input type="text" class="form-control" name="year"
										placeholder="출생년도 " size="6" value="<%=year%>">
								</div>

								<div class="col">
									<input type="hidden" name="tempMonth" value="<%=month%>"
										id="temp-month"> <select name="month"
								...
								<div class="col">
									<input type="text" class="form-control" name="day"
										placeholder="일자" size="4" value="<%=day%>">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row col-md-10 align-items-center">
							<div class="col-4 px-0">
								<input type="text" class="form-control col-md-10" name="email1"
									placeholder="이메일" value="<%=email1%>">
							</div>
							<div class="col-auto">@</div>
							<div class="col-4 px-0">
								<input type="hidden" name="tempEmail2" value="<%=email2%>"
									id="temp-email2"> <select name="email2"
									class="form-select">
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="">전화번호</label> <input
							...
							placeholder="전화번호" value="<%=loginUser.getPhone()%>">
					</div>

					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="">주소</label> <input
							type="text" class="form-control col-md-10" name="address"
							placeholder="주소" value="<%=loginUser.getAddress()%>">
					</div>


					<div class="d-flex justify-content-between mt-5 mb-5">
						<a href="javascript: ;" onclick="alertDel()"
							class="btn btn-lg btn-danger">탈퇴</a> <input type="submit"
							class="btn btn-lg btn-primary" value="수정" />
					</div>
